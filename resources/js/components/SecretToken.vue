<template>
    <modal>
        <div class="bg-40 rounded-lg shadow-lg overflow-hidden p-8" style="width: 800px">
            <h2 class="mb-3">Passport Client Secret</h2>
            
            <p class="mb-2">The secret token will never be shown again. Save this token for your records:</p>

            <button type="button" class="flex w-full bg-black text-white rounded" @click="copyToClipboard">
                <pre class="p-3 flex-1 block text-left" style="border-top-right-radius: 0; border-bottom-right-radius: 0"><code>{{ resource.secret }}</code></pre>
            ...
            <small><em>Why am I seeing this notification? <a href="https://laravel.com/docs/8.x/passport#client-secret-hashing">Learn about client secret hashing</a></em></small>
